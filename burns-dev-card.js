...
templateCard.innerHTML = `
  <style>
    ...
    */
    ...
    .btn-tools { background: linear-gradient(135deg, #6b2fa3, #5a2a88); }
  ...
  <div class="card">
    ...
    <div class="card-main-content">
      ...
      <p class="description">I like to make modern work painless, and love to build tools that are open source, private, and on device &mdash; so we can focus on our impact, not the friction.</p>
      <div class="buttons">
