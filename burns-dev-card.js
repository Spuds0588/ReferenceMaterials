...
template.innerHTML = `
  <style>
    ...
    :host {
      display: block;
      padding: 2rem; /* Applies padding to the component itself */
      max-width: 380px; /* Max-width for mobile card view */
    ...
    /* Button Brand Colors */
    .btn-tools { background-color: #5a2a88; }   /* Brand Purple */
    .btn-linkedin { background-color: #0A66C2; } /* LinkedIn Blue */
    ...
    @media (min-width: 768px) {
      :host {
        max-width: 700px; /* Wider max-width for horizontal layout */
      }
      .card {
      ...
      .buttons a {
        min-width: auto; /* Let buttons size to their content on desktop */
        padding: 0.6rem 1rem;
      }
    }
  </style>
  ...
  <div class="card">
    ...
    <div class="card-main-content">
      ...
      <p class="description">
        I'm passionate about creating solutions that solve real-world problems. Try some of my tools below, or connect with me on LinkedIn or YouTube to learn more about my work and insights.
      </p>
      <div class="buttons">
